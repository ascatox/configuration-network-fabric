...
mkdir -p ./crypto-config/peerOrganizations/org1.example.com/users/$1@org1.example.com/msp/signcerts
mkdir -p ./crypto-config/peerOrganizations/org1.example.com/users/$1@org1.example.com/msp/keystore
cp ./ca/data/msp/signcerts/cert.pem ./crypto-config/peerOrganizations/org1.example.com/users/$1@$ORG_NAME/msp/signcerts/$1@$ORG_NAME-cert.pem
cd ./ca/data/msp/keystore && cp $(ls -t | head -1) ../../../../crypto-config/peerOrganizations/$ORG_NAME/users/$1@org1.example.com/msp/keystore
